...
def is_standing_straight(im0,kpts):
    ...
    ankles = np.array([left_ankle, right_ankle])
    # 垂直對齊檢查
    ...
    #垂直對齊
    vertical_check_1 = is_vertical(hips[0], knees[0])
    vertical_check_2 = is_vertical(hips[1], knees[1])
    vertical_check_3 = is_vertical(ankles[1], knees[1])
    
    #水平對齊
    horizontal_check_1 = is_horizontal(hips[0], hips[1])
    horizontal_check_2 = is_horizontal(knees[0], knees[1])
    horizontal_check_3 = is_horizontal(ankles[0], ankles[1])

    
    

    # 檢查所有條件
    if ( vertical_check_1 and vertical_check_2 and vertical_check_3 
...
def standing_knee_flexion(im0,kpts):
    ...
    if left_knee[1]<left_hip[1]+LeftKneeToHip_Distance*0.5:
        standing_knee_flex_status="left_knee_up"
        #print("leftkneeup")
        #print("right_knee[1]:"+str(right_knee[1])+" right_hip[1]:"+str(right_hip[1])+" RightKneeToHip_Distance:"+str(RightKneeToHip_Distance))
        #print("left_knee[1]:"+str(left_knee[1])+" left_hip[1]:"+str(left_hip[1])+" LeftKneeToHip_Distance:"+str(LeftKneeToHip_Distance))
        cv2.putText(im0, f"Left Knee Up", (20, 110), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 0), 2, cv2.LINE_AA)
    elif right_knee[1]<right_hip[1]+RightKneeToHip_Distance*0.5:
        #print("rightkneeup")
        #print("right_knee[1]:"+str(right_knee[1])+" right_hip[1]:"+str(right_hip[1])+" RightKneeToHip_Distance:"+str(RightKneeToHip_Distance))
        #print("left_knee[1]:"+str(left_knee[1])+" left_hip[1]:"+str(left_hip[1])+" LeftKneeToHip_Distance:"+str(LeftKneeToHip_Distance))
