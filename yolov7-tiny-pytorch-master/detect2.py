...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='0', help='source')  # file/folder, 0 for webcam data/images
    parser.add_argument('--img-size', nargs= '+', type=int, default=360, help='inference size (pixels)')#640
