...
left_arm_angle_prev = 120  # 假設手臂初始為伸直狀態
right_arm_angle_prev = 120
...
def detect_hand_raise(kpts):
    ...
    # 手腕要高於肩膀，手肘要高於肩膀
    if (right_wrist[1] < right_shoulder[1] and right_elbow[1] < right_shoulder[1] and 
        left_wrist[1] < left_shoulder[1] and left_elbow[1] < left_shoulder[1] and 
        kpts[17] > confidence and kpts[23] > confidence and kpts[29] > confidence and 
        kpts[20] > confidence and kpts[26] > confidence and kpts[32] > confidence):
        return "raise two hands"
    if (left_wrist[1] < left_shoulder[1] and left_elbow[1] < left_shoulder[1] and 
